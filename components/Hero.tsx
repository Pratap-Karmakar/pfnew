...
export default function Hero({ }: Props) {
    return (
        <div>
            <div className='relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-32 h-32 top-6  md:top-1 overflow-hidden md:h-60 md:w-60 '>
            <Image src={avatar} layout='fill' objectFit='cover' alt='Avatar Image'/>
          </div>
        <div className='text-center py-6 md:p-0 md:mt-10'>
